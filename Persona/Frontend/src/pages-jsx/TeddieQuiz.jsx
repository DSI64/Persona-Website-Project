...
const QUIZ_DATA = {
  P3: [
    {
      id: 1,
      question: "What is the name of the high school attended by the members of SEES?",
      options: ["Shujin Academy", "Gekkoukan High School", "Yasogami High School", "Koumi High"],
      correct: 1,
    ...
    },
    {
      ...
      options: ["The Dark Hour", "The Midnight Channel", "The Phantom Time", "The Velvet Hour"],
      correct: 0,
      teddieComment: "The Dark Hour! When coffins line the streets—spooky!"
    },
    {
      id: 3,
      question: "What colossal tower serves as the main dungeon during the Dark Hour?",
      options: ["Mementos", "The TV World", "Tartarus", "The Velvet Tower"],
      correct: 2,
      teddieComment: "Tartarus! Climbing that thing takes some serious stamina, bear-y true!"
    }
  ],
  P4: [
    {
      id: 1,
      question: "What is the name of the local department store chain found in Inaba?",
    ...
    {
      id: 2,
      question: "Through what household object do the Investigation Team enter the Midnight Channel?",
      options: ["A retro microwave", "A flat-screen TV", "An old-box television", "A magical mirror"],
      correct: 2,
      teddieComment: "Spot on! Just don't lean too close or you'll fall right through!"
    },
    {
      id: 3,
      question: "What is the primary weather phenomenon that plagues Inaba before major events?",
      options: ["Heavy snowstorms", "Mysterious dense fog", "Acid rain", "Endless sunshine"],
      correct: 1,
  ...
  P5: [
    {
      ...
      options: ["Shujin Academy", "Gekkoukan High School", "Yasogami High School", "Yongen High"],
      correct: 0,
      teddieComment: "Shujin Academy! Watch out for those strict teachers!"
    },
    {
      id: 2,
      question: "What is the name of the cognitive collective dungeon that represents the public's desires?",
    ...
    {
      id: 3,
      question: "What alias does Joker use as the leader of the Phantom Thieves?",
    ...
    <div className="p4-quiz-container">
      ...
      <div className="quiz-header">
        <div className="quiz-title-group">
          <h1>MIDNIGHT <span className="yellow-highlight">QUIZ SHOW</span></h1>
          <p className="subtitle-spacing">HOSTED BY TEDDIE // INABA BROADCAST NETWORK</p>
        </div>
        {gameState === 'PLAYING' && (
      ...
      {gameState === 'START' && (
        <div className="quiz-setup-card">
          <div className="setup-intro">
            ...
            <p>Choose your target archive and broadcast difficulty before stepping into the spotlight!</p>
          </div>
        ...
        <div className="quiz-workspace">
          <div className="quiz-stage-card">
            <div className="stage-meta-row">
              ...
              <span className={`timer-display ${timeLeft <= 2 ? 'warning' : ''}`}>⏱ TIME: {timeLeft}s</span>
              <span className="channel-tag">{selectedGame} ({difficulty.toUpperCase()})</span>
            </div>
      ...
      {gameState === 'FINISHED' && (
        <div className="quiz-results-card">
          <div className="results-content">
            ...
            <p className="results-subtitle">You survived Teddie's Midnight Quiz Show ({selectedGame})!</p>
